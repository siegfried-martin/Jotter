...
//     collab later.
//   * LWW  track (checklist, diagram, table, timeline, calendar) — mutation outbox +
//     last-write-wins + compare-and-swap conflict detection. The editor mirrors a JSON blob
//     into `content` (Excalidraw scene / Univer workbook snapshot / our own Timeline or
//     Calendar doc); no Yjs.
//
